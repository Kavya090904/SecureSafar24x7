...
const PlacementRegister = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-card rounded shadow">
      <h2 className="text-2xl font-bold mb-4">Placement Cell Registration</h2>
      ...
      <div className="mt-4 text-center">
        <a href="/placement/login" className="text-primary underline">Already have an account? Login</a>
      </div>
    </div>
  );
};
